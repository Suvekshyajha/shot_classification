...
class ShotAnalytics:
    ...
    def compute(self, events, total_frames, fps):
        ...
        # if no shots detected return empty
        if not events:
        ...
        # ── timeline: how many shots every 10 seconds ─────────────────
